...
# Configuration Script – MacSync - W - Rev. A

This **Configuration** script is designed for the **MacSync - W** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – MacSync - W Rev. A

Este script de **Configuration** está diseñado para el modelo **MacSync - W** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
